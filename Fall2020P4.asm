...
again:
	...
	CJNE 	A, #16, skip	; If the number of revolutions is not 10, skip next instruction.
...
LEDcodes:	; | This label points to the start address of the 7-segment code table which is 
	...
	DB 11000000B, 11111001B, 10100100B, 10110000B, 10011001B, 10010010B, 10000010B, 11111000B, 10000000B, 10010000B, 10001000B, 10000011B, 11000110B, 10100001B, 10000110B, 10001110B
;ccwLED:
;	DB 10001110B, 10000110B, 10100001B, 11000110B, 10000011B, 10001000B, 10010000B, 10000000B, 11111000B, 10000010B, 10010010B, 10011001B, 10110000B, 10100100B, 11111001B, 11000000B
;cw:
	;MOV 	DPL, #LOW(LEDcodes)	; Put the low byte of LEDcodes into DPL.
	;MOV 	DPH, #HIGH(LEDcodes)	; Put the high byte of LEDcodes into DPH.
	;RET
;ccw:
	;MOV 	DPL, #LOW(ccwLED)	; Put the low byte of LEDcodes into DPL.
	;MOV 	DPH, #HIGH(ccwLED)	; Put the high byte of LEDcodes into DPH.
	;RET